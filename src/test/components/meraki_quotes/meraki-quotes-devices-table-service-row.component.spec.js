...
import MerakiQuotesDevicesTableServiceRow from '../../../components/meraki_quotes/meraki-quotes-devices-table-service-row.component.js'

import {quote} from './meraki-quotes.fixtures.js'

describe('<MerakiQuotesDevicesTableServiceRow />', function(){
	...
	it('should have the service cost properly formatted', function(){
		...
		expect(p.type).to.equal('p')
		expect(p.props.children).to.equal('$53,40')
	})
